...
FILE_FORMATS = [# 00. から10. は選ばれた10個体のみファイルに保存
                ...
                # 30. 圧縮版, 対ランダム, 指し手固定, 個体数50, エリートなし, 等比数列ランキング選択公比0.50, 2人っ子一様交叉, ラン突1%
...
# そろそろめんどい
COMPRESSED_INDICES = [26, 27, 28, 29, 30, 31, 32]

# 各フォーマットでどのシードを使ったのか記録
# フォーマットにシードが付いているかの判定に使える
SEED_DICT = {27: (123, 365, 999), 28: (365,), 29: (123, 999), 30: (123,), 31: (123,), 32: (123,)}
