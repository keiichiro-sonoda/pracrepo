...
class Widget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        sl.showSPRM_EFF()
        self.use_sprm = slw.getSPRM_EFFWrap()
        # ボタン等設定
        self.setButtons()
    ...
    def _printBoard(self, board):
        moji = ""
        for y in range(9, 81, 9): # 縦
            # 文字列の先頭を改行文字にする
            moji = "\n" + moji
            for x in range(1, 9): # 横
                # 文字列の先頭に加えてゆく
    ...
    def setButtons(self):
        ...
        self.reset_button.setStyleSheet("            font-size:20pt;            font-weight:thin;            font-family:Times New Roman;            background:#ffffff")
    ...
    def randomAction(self):
        ...
        tag = slw.getBestActABSprmWrap(self.board_info, 1, self.turn)
        # 盤面更新
        self.updateBoard(tag)
        # 次が人ならターンをロック解除
...
class Application(QApplication):
    ...
    def setButtons(self):
        ...
        self.end_button.setStyleSheet("            font-size:15pt;            font-weight:100;            font-family:游明朝;            background:#ff0000")
        ...
        self.show_normal_button.setStyleSheet("            font-size:15pt;            font-weight:800;            font-family:游明朝;            background:lime green")
